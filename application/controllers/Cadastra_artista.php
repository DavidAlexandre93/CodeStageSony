...
class Cadastra_artista extends CI_Controller {
	...
	public function cad_artista(){
        ...
        $retorno = $this->M_cadastra->cad_artista($senha, $nome, $email, $nasc, $expe, $natural, $end, $est, $prof, $nome,$nasc, $expe, $natural, $end, $est, $prof);
